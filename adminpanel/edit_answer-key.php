...
$answerkey_id = $_GET['id'];

$query = "SELECT * FROM answerkey_data WHERE answerkey_id = '$answerkey_id'";
...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update = "UPDATE answerkey_data SET answerkey_title = '$answerkey_title', answerkey_discription = '$answerkey_discription',category = '$category', author_name = '$author_name' WHERE answerkey_id = '$answerkey_id'";
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <header>
                            <h1><i class="bi bi-caret-right-fill"></i> Edit Answer Key Blog</h1>
                        ...
                        <div class="card-body">
                            ...
                            <form id="blog-form" method="post" action="" enctype="multipart/form-data">
                                ...
                                <a href="answer_key_page.php" class="btn btn-danger my-3" type="button" name="cancel">Cancel</a>
                            </form>
                        </div>
                    </div>
                </div>
