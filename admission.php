...
<div class="container">
    ...
    <div class="row my-3">
        <div class="col-sm-8 col-md-8 col-12">
            ...
            <div class="card my-3">
                <div class="card-title p-3">
                    <a href="admission-allnews.php?admission_name=<?php echo urlencode($post['admission_name']); ?>">
                ...
                <div class="card-body">
                    ...
                    <div class="link-part my-5">
                        ...
                        <p><i class="bi bi-chat-left-dots-fill"></i> <a
                                href="admission-allnews.php?admission_id=<?php echo $post['admission_id'];?>#comment-section">Leave
                                a
                                comment</a></p>
                    </div>
                </div>
                ...
                <div class="card-body p-3">
                    <ul>
                        ...
                        <div style="display: flex; gap: 10px;">
                            <a href="./admission-allnews.php?=<?php echo $title['admission_name']; ?>"
