...
if(isset($_POST['delete_id'])){
    ...
    $delete_query = "DELETE FROM result_data WHERE result_id = '$delete_id'";
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-tools d-flex justify-content-center align-items-center" style="gap: 12px;">
                                ...
                                <a href="add_result.php" class="btn btn-outline-secondary"><i class="bi bi-plus"></i>
                                    Add Result Data</a>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="card-body">
                                    <h4 class="card-title"><strong><?php echo $post['result_title']; ?></strong></h4>
                                    <!-- <p class="card-text"><?php echo $post['result_discription']; ?></p> -->
                                    ...
                                    <form action="" method="post" class="d-flex" style="gap: 10px;"
                                        id="deleteBlog_<?php echo $post['result_id']?>"
                                        onsubmit="return confirm('Are you sure you want to delete this blog?')">
                                        <a class="btn btn-outline-warning edit-news-btn"
                                            href="edit_result.php?id=<?php echo $post['result_id']; ?>"
                                            data-edit-id="<?php echo $post['result_id']; ?>">Edit Blog</a>
                                        <input type="hidden" name="delete_id" value="<?php echo $post['result_id']?>">
                                        <button class="btn btn-outline-danger delete-button"
                                            data-delete-id="<?php echo $row['result_id']; ?>"><i
