...
$sql = "SELECT * FROM state_related_blog ORDER BY created_at DESC";
...
if(isset($_POST['delete_id'])){
    ...
    $delete_query = "DELETE FROM state_related_blog WHERE id = '$delete_id'";
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-tools d-flex justify-content-center align-items-center" style="gap: 12px;">
                                ...
                                <a href="add_state_blog.php" class="btn btn-outline-secondary"><i class="bi bi-plus"></i>
                                    Add Other Post</a>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="card-body">
                                    <h4 class="card-title"><strong><?php echo $post['state_title']; ?></strong></h4>
                                     <!-- <p class="card-text"><?php echo $post['state_discription']; ?></p> -->
                                    ...
                                    <form action="" method="post" class="d-flex" style="gap: 10px;"
                                        id="deleteBlog_<?php echo $post['id']?>"
                                        onsubmit="return confirm('Are you sure you want to delete this blog?')">
                                        <a class="btn btn-outline-warning edit-news-btn"
                                            href="edit_state_related.php?id=<?php echo $post['id']; ?>"
                                            data-edit-id="<?php echo $post['id']; ?>">Edit Blog</a>
                                        <input type="hidden" name="delete_id"
                                            value="<?php echo $post['id']?>">
                                        <button class="btn btn-outline-danger delete-button"
                                            data-delete-id="<?php echo $row['id']; ?>"><i
