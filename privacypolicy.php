...
<div class="container">
    <div class="row my-3">
        <div class="col-sm-8 col-md-8 col-12" style="position: relative;">
            <div class="scrollspy" data-bs-target="#right-sidebar" data-bs-smooth-scroll="true" tabindex="0">
                <div class="card">
                    <div class="card-title p-3">
                        <h1>Privacy Policy</h1>
                    </div>
                    <div class="card-body">
                        <p>At Think Govt Jobs, accessible from <a
                                href="https://thinkgovtjobs.com/">https://thinkgovtjobs.com/</a> , one of our main
                            priorities is the
                            privacy of our visitors. This Privacy Policy document contains types of information that is
                            collected and recorded by Think Govt Jobs and how we use it.
                            <br>
                            <br>
                            ...
                            website with regards to the information that they shared and/or collect in Think Govt Jobs.
                            This
                        ...
                        <p>Think Govt Jobs follows a standard procedure of using log files. These files log visitors
                            when
                        ...
                        <p>Like any other website, Think Govt Jobs uses “cookies”. These cookies are used to store
                        ...
                        <p>You may consult this list to find the Privacy Policy for each of the advertising partners of
                            ...
                            Beacons
                            that are used in their respective advertisements and links that appear on Think Govt Jobs,
                            which
                            ...
                            <br>
                            <br>
                            Note that Think Govt Jobs has no access to or control over these cookies that are used by
                            third-party advertisers.
                        </p>
                        <br>
                        <br>
                        <h2><strong>Third Party Privacy Policies</strong></h2>
                        <p>Think Govt Jobs’s Privacy Policy does not apply to other advertisers or websites. Thus, we
                            are
                        ...
                        <p>Another part of our priority is adding protection for children while using the internet. We
                            ...
                            <br>
                            <br>
                            Think Govt Jobs does not knowingly collect any Personal Identifiable Information from
                            children
