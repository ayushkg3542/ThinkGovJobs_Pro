<?php
 ...
 $sql = "SELECT * FROM syllabus_data LEFT JOIN blog_category ON syllabus_data.category=blog_category.category_id WHERE syllabus_title like '%$table_search%' or syllabus_discription like '%$table_search%' ORDER BY date DESC limit $offset, $limit";
 ...
 if($result->num_rows > 0){
    while ($row = $result->fetch_assoc()) {
        ...
        $row['syllabus_discription'] = substr($row['syllabus_discription'],0 ,500) . '...';
...
<div class="container">
    <div class="row my-3">
        <div class="col-sm-8 col-md-8 col-12">
            ...
            <div class="card my-3">
                <div class="card-title p-3">
                    <a href="syllabus-allnews.php?syllabus_id=<?php echo $post['syllabus_id']; ?>">
                        <h2><?php echo $post['syllabus_title']; ?></h2>
                    </a>
                    <span><?php echo $post['date']?></span>
                </div>
                <div class="card-body">
                    <div class="card-text">
                        <p><?php echo $post['syllabus_discription']; ?><a
                                href="syllabus-allnews.php?syllabus_id=<?php echo $post['syllabus_id']; ?>">Read
                                More</a></p>
                    </div>
                    <div class="link-part my-5">
                        <p><i class="bi bi-folder-fill"></i> <a href="syllabus.php">Syllabus</a></p>
                        <p><i class="bi bi-chat-left-dots-fill"></i> <a
                                href="syllabus-allnews.php?syllabus_id=<?php echo $post['syllabus_id']; ?>">Leave a
                                comment</a></p>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
            <?php 
                $pagination ="SELECT * FROM syllabus_data"; 
            ...
            <ul class="pagination pt-2 pb-5">
                ...
                <li class="page-item <?= ($i==$page) ? $active = 'active':'';?>">
                    <a href="syllabus.php?page_no=<?= $i?>" class="page-link"><?= $i?></a>
                </li>
                <?php }?>
            </ul>
        </div>
        <div class="col-sm-4 col-md-4 col-12">
            <div class="card mb-3">
                ...
                ?>
                <form action="syllabus_search.php" method="GET">
