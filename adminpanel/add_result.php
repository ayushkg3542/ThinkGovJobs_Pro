...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO result_data (result_title, result_discription, category, author_name) VALUES (?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssss", $result_title, $result_discription, $category, $author_name);
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                <a href="result_page.php" class="btn btn-secondary btn-sm"><i class="bi bi-chevron-left"></i> Back</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="blog-form" method="post" action="" enctype="multipart/form-data">
                                ...
                                <input type="text" id="title" name="result_title" required>
