...
if(isset($_POST['delete_id'])){
    ...
    $delete_query = "DELETE FROM answerkey_data WHERE answerkey_id = '$delete_id'";
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="card-tools d-flex justify-content-center align-items-center" style="gap: 12px;">
                                ...
                                <a href="add_answer-key.php" class="btn btn-outline-secondary"><i
                                        class="bi bi-plus"></i>
                                    Add Answer Key Data</a>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-4">
                                <div class="card-body">
                                    <h4 class="card-title"><strong><?php echo $post['answerkey_title']; ?></strong></h4>
                                    <!-- <p class="card-text"><?php echo $post['answerkey_discription']; ?></p> -->
                                    ...
                                    <form action="" method="post" class="d-flex" style="gap: 10px;"
                                        id="deleteBlog_<?php echo $post['answerkey_id']?>"
                                        onsubmit="return confirm('Are you sure you want to delete this blog?')">
                                        <a class="btn btn-outline-warning edit-news-btn"
                                            href="edit_answer-key.php?id=<?php echo $post['answerkey_id']; ?>"
                                            data-edit-id="<?php echo $post['answerkey_id']; ?>">Edit Blog</a>
                                        <input type="hidden" name="delete_id"
                                            value="<?php echo $post['answerkey_id']?>">
                                        <button class="btn btn-outline-danger delete-button"
                                            data-delete-id="<?php echo $row['answerkey_id']; ?>"><i
