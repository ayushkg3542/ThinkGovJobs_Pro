...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO admitcard_data (admitcard_title, admitcard_discription, category, author_name) VALUES (?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssss", $admitcard_title, $admitcard_discription, $category, $author_name);
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <a href="admit_card_page.php" class="btn btn-secondary btn-sm"><i class="bi bi-chevron-left"></i>
                        Back</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <header>
                            <h1><i class="bi bi-caret-right-fill"></i> New Admit Card Blog</h1>
                        ...
                        <div class="card-body">
                            ...
                            <form id="blog-form" method="post" action="" enctype="multipart/form-data">
                                ...
                                <input type="text" id="title" name="admitcard_title" required>

                                <label for="author_name">Author Name:</label>
                                <input type="text" id="author_name" name="author_name" required>

                                <label for="admission">Content:</label>
                                <textarea contenteditable="true" id="editor" name="admitcard_discription" rows="10"
