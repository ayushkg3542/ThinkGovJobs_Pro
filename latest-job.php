<?php
 ...
 $sql = "SELECT * FROM latestjob_data LEFT JOIN blog_category ON latestjob_data.category=blog_category.category_id ORDER BY date DESC limit $offset, $limit";
...
<div class="container">
    ...
    <div class="row my-3">
        <div class="col-sm-8 col-md-8 col-12">
            ...
            <div class="card my-3">
                <div class="card-title p-3">
                    <a href="latest-job-allnews.php?latestjob_id=<?php echo $post['latestjob_id']; ?>">
                        <h2><?php echo $post['latestjob_title']; ?></h2>
                    </a>
                    <span><?php echo $post['date']?></span>
                </div>
                <div class="card-body">
                    <div class="card-text">
                        <p><?php echo $post['latestjob_discription']; ?><a
                                href="latestjob-allnews.php?latestjob_id=<?php echo $post['latestjob_id']; ?>">Read
                                More</a></p>
                    </div>
                    <div class="link-part my-5">
                        <p><i class="bi bi-folder-fill"></i> <a href="latest-job.php">Latest Job</a></p>
                        <p><i class="bi bi-chat-left-dots-fill"></i> <a
                                href="latestjob-allnews.php?latestjob_id=<?php echo $post['latestjob_id']; ?>">Leave a
                                comment</a></p>
                    </div>
                </div>
            </div>
            ...
            <ul class="pagination pt-2 pb-5">
                ...
                <li class="page-item <?= ($i==$page) ? $active = 'active':'';?>">
                    <a href="latest-job.php?page_no=<?= $i?>" class="page-link"><?= $i?></a>
                </li>
                <?php }?>
            </ul>
        </div>
        <div class="col-sm-4 col-md-4 col-12">
            <div class="card mb-3">
                ...
                ?>
                <form action="latestjob_search.php" method="GET">
                ...
                <div class="card-body p-3">
                    <ul>
                        ...
                        <div style="display: flex; gap: 10px;">
                            <a href="./latest-job-allnews.php?latestjob_id=<?php echo $title['latestjob_id']; ?>"
