...
$query = "SELECT * FROM marquee_data WHERE id = '$id'";
$query_result = mysqli_query($conn, $query);
$rows = mysqli_fetch_assoc($query_result);

if($_SERVER['REQUEST_METHOD'] == "POST"){
    $marquee_name = $_POST['marquee_name'];
    $post_url = $_POST['post_url'];

    $marquee_name = trim($marquee_name);
    $post_url = trim($post_url);

    $update = "UPDATE marquee_data SET marquee_name = '$marquee_name', post_url = '$post_url' WHERE id = '$id'";
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                <div class="input-group mb-3">
                                    <input type="text" name="marquee_name" value="<?= $rows['marquee_name']?>"
                                        class="form-control" required>
                                </div>
                                <div class="input-group mb-3">
                                    <input type="text" name="post_url" value="<?= $rows['post_url']?>"
                                        class="form-control" required>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="" method="post">
                                ...
                                <div class="d-flex mt-3" style="gap: 10px;">
                                    <input type="submit" name="headline" value="Submit"
                                        class="btn btn-outline-warning">
