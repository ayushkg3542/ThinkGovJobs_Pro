...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO syllabus_data (syllabus_title, syllabus_discription, category, author_name) VALUES (?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssss",$syllabus_title, $syllabus_discription, $category, $author_name);
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                <a href="syllabus_page.php" class="btn btn-secondary btn-sm"><i class="bi bi-chevron-left"></i> Back</a>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form id="blog-form" method="post" action="" enctype="multipart/form-data">
                                ...
                                <input type="text" id="title" name="syllabus_title" required>

                                <label for="author_name">Author Name:</label>
                                <input type="text" id="author_name" name="author_name" required>

                                <label for="admission">Content:</label>
                                <textarea contenteditable="true" id="editor" name="syllabus_discription" rows="10"
